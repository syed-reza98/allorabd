<template>
    <div 
        :id="'ProductComponent' + product.data.id"
        class="
            bg-white 
            inline-block 
            rounded 
        ...
        <!-- <NuxtLink :to="/item/${product.id}"> -->
            ...
            <div id="ProductDetails">
                ...
                <span class="flex items-center justify-start gap-3 px-1 pt-1">
                    <span class="text-[#FF6674] font-semibold">${{ product.data.price }}</span>
                    <!-- <span class="text-sm text-gray-500 line-through text-light">${{ oldPriceComputed }}</span> -->
                </span>
